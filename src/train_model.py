...
ax[1][0].plot(x, history['train_gender_acc'], label='train')
ax[1][0].plot(x, history['val_gender_acc'], label='val')
ax[1][0].set_title("Gender Accuracy")
ax[1][0].set_xlabel("epoch")
ax[1][0].set_ylabel("accuracy(%)")
ax[1][0].set_xticks(x_tick)
ax[1][0].legend()

ax[1][1].plot(x, history['train_race_acc'], label='train')
ax[1][1].plot(x, history['train_race_acc'], label='val')
ax[1][1].set_title("Race Accuracy")
